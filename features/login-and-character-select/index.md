...
- [agents/net/index.md](../../agents/net/index.md) — 登录握手协议（LoginHandlers、LoginPackets、CharCreationPackets）
- [agents/io/index.md](../../agents/io/index.md) — 所有登录/角色创建 UI（UIStateLogin）
